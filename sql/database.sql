...
INSERT INTO auth_user (user_id, username, profile_id, status_id)
VALUES
((SELECT id FROM users WHERE idem = 'V-12345678'), 'juan.perez', (SELECT id FROM profile WHERE name = 'Administrador'), 1),
((SELECT id FROM users WHERE idem = 'V-87654321'), 'maria.gonzalez', (SELECT id FROM profile WHERE name = 'Vendedor'), 1),
((SELECT id FROM users WHERE idem = 'V-11223344'), 'carlos.lopez', (SELECT id FROM profile WHERE name = 'Almacenero'), 1),
((SELECT id FROM users WHERE idem = 'V-44332211'), 'ana.martinez', (SELECT id FROM profile WHERE name = 'Comprador'), 1),
((SELECT id FROM users WHERE idem = 'V-99887766'), 'pedro.ramirez', (SELECT id FROM profile WHERE name = 'Gerente'), 1);
